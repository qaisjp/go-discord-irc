...
func prepareHome(dib *Bridge, discord *discordBot, ircPrimary *ircPrimary) {
	dib.h = &home{
		dib:        dib,
		discord:    discord,
		ircPrimary: ircPrimary,
...
func (h *home) discordUserToIRC(userID string) string {
	...
	return fmt.Sprintf("%s[discord-%s]", u.Username, u.Discriminator)
}
